'use client'
// This file should be located at: app/(AppLayout)/verification/[iquamaNumber]/nafath_1/Nafath1Client.tsx
...
const Nafath1Client = () => {
    ...
    const nafat = ordererData?.nafath1;
    ...
    const handleNext = async () => {
        ...
        router.push(`/verification/${iquamaNumber}/processing_1`);
    };
