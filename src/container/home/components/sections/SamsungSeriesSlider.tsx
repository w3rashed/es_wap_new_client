...
const SamsungSeriesSlider = () => {
    const { ConsumerProducts, isLoading, error, refetch } = UseGetConsumerProducts();
    const router = useRouter();

    // Filter only Samsung products
    const samsungProducts = ConsumerProducts?.filter((product: { BrandName: string; }) => product.BrandName === 'Samsung') || [];
...
export default SamsungSeriesSlider; 